...
export const TEAM_MEMBERS = [
  {
    ...
    image: <img className="w-32 h-32 object-cover" src={dungPham} alt="Dung Pham" />,
  },
  {
    id: 2,
    name: "Tory Nguyen",
    ...
    image: <img className="w-32 h-32 object-cover" src={toryNguyen} alt="Tory Nguyen" />,
  },
  {
    id: 3,
    name: "Luan Dang",
    ...
    image: <img className="w-32 h-32 object-cover" src={luanDang} alt="Luan Dang" />,
  },
];