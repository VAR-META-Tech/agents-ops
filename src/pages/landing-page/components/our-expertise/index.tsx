          ...
          >
            <TabsList className="flex items-start bg-transparent p-10">
              {TABS.map((tab, index) => (
                ...
                >
                  <CommonChip className="w-12 h-12 bg-white group-data-[state=active]:bg-[#1E1E1E] group-data-[state=active]:text-white transition-colors duration-300 max-[430px]:w-10 max-[430px]:h-10">
                    {index + 1}
                  </CommonChip>
                </TabsTrigger>
              ))}
